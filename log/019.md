...
Software wise, key management and signing can be automated with:
 ...
 - [**horcrux**(*advanced: protects against [double-signing](https://github.com/tendermint/tendermint/blob/v0.34.x/spec/consensus/signing.md#double-signing)*)](https://github.com/strangelove-ventures/horcrux/blob/main/docs/migrating.md)
