...
#### General Considerations and Private Keys
---
...
#### Private Keys
---
It's important to separate private key management from the nodes themselves. From the [**Tendermint docs on private keys for validators**](https://docs.tendermint.com/v0.34/tendermint-core/validators.html#validator-keys):
...
Software wise, key management and signing can be automated with:
 ...
 - [**horcrux**(*advanced*)](https://github.com/strangelove-ventures/horcrux/blob/main/docs/migrating.md) which protects against double-signing
 ...
 Key Generation and Signing can be done with any form of [**Hardware Security Module HSM**](https://docs.evmos.org/validators/security/security.html#hardware-hsm) that utilizes [**ED25519**](https://ed25519.cr.yp.to/) encryption like:
  ...
  - [**network integrated HSM solution**](https://cpl.thalesgroup.com/encryption/hardware-security-modules).
...
### Further Reading
---
 - [**awesome cosmos articles**](https://github.com/cosmos/awesome-cosmos#articles) such as:
