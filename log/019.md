...
Software wise, key management and signing can be automated with:
 ...
 - [**horcrux**](https://github.com/strangelove-ventures/horcrux/blob/main/docs/migrating.md) [(*advanced: double-signinging mitigation*](https://github.com/tendermint/tendermint/blob/v0.34.x/spec/consensus/signing.md#double-signing)
